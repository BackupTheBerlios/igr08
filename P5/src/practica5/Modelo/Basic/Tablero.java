...
public class Tablero extends Malla {
    ...
    /* El tablero est� formado por una serie de cubos o planos paralelos entr� s�
     * Por ello, vamos a irlo creando en orden...
     *      1� Calculamos el primer plano
     *      2� Calulamos los planos intermedios
     *      3� Calculamos el �ltimo plano
    ...
    public Tablero(double X, double Y, double Z,
        ...
        // Insertamos las caras y las normales del 1� plano
        ...
        // Insertamos las caras y las normales del �ltimo plano
        calcularCarasYnormalesYZ(divY, divZ, numPlanos);
        calcularCarasYnormalesXZ(divX, divY, divZ, numPlanos);
        calcularCarasYnormalesXY(divX, divY, divZ, numPlanos);
    }
    
    // M�todo que genera el plano
    ...
    // M�todo que calcula las normales entre cada par de ejes
