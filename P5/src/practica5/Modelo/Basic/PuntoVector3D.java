...
public class PuntoVector3D implements Serializable {
    ...
    public PuntoVector3D mas(PuntoVector3D PV0) {
        this.x = x + PV0.getX();
        this.y = y + PV0.getY();
        this.z = z + PV0.getZ();
        return this;
    ...
    public PuntoVector3D menos(PuntoVector3D PV0) {
        this.x = x - PV0.getX();
        this.y = y - PV0.getY();
        this.z = z - PV0.getZ();
        return this;
    ...
    public PuntoVector3D cross(PuntoVector3D v) {
        PuntoVector3D res = new PuntoVector3D();
