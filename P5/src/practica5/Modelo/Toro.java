...
public class Toro extends Malla {
     ...
     *	y = r � sin (t)
     */
    private int nP,  nQ; // nP: n� de lados del pol�gono de la seccion del toro
    // nQ = n� de capas del toro
     ...
     * @param nP: N�mero de lados que aproximan la secci�n del toroide
     * @param nQ: N�mero de capas del toroide
     * @param r1: Radio del toro. Radio "grande"
     * @param r2: Radio de la secci�n del toro. Radio "peque�o"
     */
