...
public class Persona extends ObjetoCompuesto3D {
    ...
    public Persona(PuntoVector3D pos, double ori, GL gl) {
        ...
        cabeza.setGL(gl);
        cabeza.getMatriz().trasladarM(pos.getX() + 20, pos.getY() + 107, pos.getZ());
        ...
        // Pierna 1
        articulacion = new Tablero(17, 63, 10, 5, 5, 5);
        articulacion.setId(Objeto3D.PERSONA);
        articulacion.setGL(gl);
        articulacion.getMatriz().trasladarM(pos.getX() + 20, pos.getY(), pos.getZ());
        ...
        articulacion.setId(Objeto3D.PERSONA);
        articulacion.setGL(gl);
        articulacion.getMatriz().trasladarM(pos.getX() + 2, pos.getY(), pos.getZ());
        articulacion.setColor(color.azulOscuro);
        this.addHijos(articulacion);
        ...
        articulacion.setId(Objeto3D.PERSONA);
        articulacion.setGL(gl);
        articulacion.getMatriz().trasladarM(pos.getX() + 40, pos.getY() + 55, pos.getZ());
        ...
        articulacion.setId(Objeto3D.PERSONA);
        articulacion.setGL(gl);
        articulacion.getMatriz().trasladarM(pos.getX() - 15, pos.getY() + 55, pos.getZ());
        articulacion.setColor(color.marron);
        this.addHijos(articulacion);
