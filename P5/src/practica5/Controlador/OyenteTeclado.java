    ...
    public void modificarEscena(KeyEvent e) {
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_7:
                ...
                escena.getObjeto3D().getMatriz().rotaXM(1);
                break;
            ...
            case KeyEvent.VK_0:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().rotaYM(1);
                break;
            ...
            case KeyEvent.VK_5:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().rotaZM(1);
                break;
            ...
            case KeyEvent.VK_F:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().escala1X(1.2);
                break;
                
            case KeyEvent.VK_V:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().escala1X(0.8);
                break;
                
            case KeyEvent.VK_G:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().escala1Y(1.2);
                break;
            case KeyEvent.VK_B:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().escala1Y(0.8);
                break;
            case KeyEvent.VK_H:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().escala1Z(1.2);
                break;
            case KeyEvent.VK_N:
                escena.getObjeto3D().setModificado();
                escena.getObjeto3D().getMatriz().escala1Z(0.8);
                break;
